...
<div class="w-[90%] lg:w-2/3 mx-auto lg:min-h-[100vh] lg:grid lg:grid-cols-2 lg:gap-6 pt-6 lg:pt-[6em]">
    ...
    <div class="right lg:w-1/2 mt-4 lg:mt-0">
        ...
        <p class="text-[1.25em] mt-2">P {{$bundle->price_per_head}}/head</p> 
        <p class="text-[1em] text-dark-gray mt-4">{{$bundle->description}}</p> 
        ...
        <form action="{{ route('bundle.select', $bundle->id) }}" method="POST">
            @csrf
